#Pmod for sync J53.5/ sg swp  J53.1
set_property PACKAGE_PIN AM16 [get_ports pmod_sync_in]
set_property PACKAGE_PIN AL14 [get_ports pmod_sgswp_in]
set_property IOSTANDARD LVCMOS12 [get_ports pmod_sync_in]
set_property IOSTANDARD LVCMOS12 [get_ports pmod_sgswp_in]

#IIC EEPROM
set_property PACKAGE_PIN J24 [get_ports IIC_MAIN_SCL]
set_property IOSTANDARD LVCMOS18 [get_ports IIC_MAIN_SCL]
set_property PACKAGE_PIN J25 [get_ports IIC_MAIN_SDA]
set_property IOSTANDARD LVCMOS18 [get_ports IIC_MAIN_SDA]
set_property PACKAGE_PIN AP10 [get_ports IIC_MUX_RESET_B]
...
create_clock -name sgmiiclk_p -period 1.600 [get_ports sgmiiclk_p]
...
## "CLK_300MHZ_P", "CLK_300MHZ_N"
#set_property ODT RTT_48 [get_ports sysclk_300MHz_p]
#set_property ODT RTT_48 [get_ports sysclk_300MHz_n]
#set_property PACKAGE_PIN AK17 [get_ports sysclk_300MHz_p]
#set_property PACKAGE_PIN AK16 [get_ports sysclk_300MHz_n]
#set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports sysclk_300MHz_p]
#set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports sysclk_300MHz_n]
...
create_clock -name clk_ab_p -period 4.0 [get_ports clk_ab_p]
...
-group {clk_ab_p clkfbout_adc_clock clk_out1_adc_clock clk_out2_adc_clock clk_out3_adc_clock clk_div } \
-group {sysclk_125MHz_p clkfbout_system_clock clk_out1_system_clock } \
-group {sgmiiclk_p clk_fb_i clk125_i clk625_i clk312_out clk625_i_INTERNAL_DIVCLK}
