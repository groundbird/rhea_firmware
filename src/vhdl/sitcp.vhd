...
architecture Behavioral of sitcp is
  ...
  component axku042_open_net_core is
    port (
      clk_200         : in    std_logic;
      rst             : in    std_logic;
      force_defaultn  : in    std_logic;
      ...
      iic_main_sda    : inout std_logic;
      iic_main_scl    : out   std_logic);
  end component axku042_open_net_core;

begin

  gen_sitcp : if not USE_OPEN_NET generate
  ...
  end generate gen_sitcp;

  gen_open_net : if USE_OPEN_NET generate
    u_axku042_open_net_core : axku042_open_net_core
      port map (
        clk_200         => clk_200,
        rst             => rst,
        force_defaultn  => force_defaultn,
